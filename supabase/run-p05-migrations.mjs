// P05 Migration Runner — runs migrations 007, 008, 009
// node supabase/run-p05-migrations.mjs
...
async function main() {
  console.log('=== P05 Migration Runner: Item Master & Warehouse Foundation ===\n')
  ...
  const files = [
    'migrations/007_item_master.sql',
    'migrations/008_warehouses_stock.sql',
    'migrations/009_stock_movements.sql',
  ]
