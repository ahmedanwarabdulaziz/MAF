...
export default function InvoiceAttachmentsButton({ urls }: { urls: string[] }) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" dir="rtl">
          ...
          <div className="relative w-full max-w-4xl bg-white rounded-2xl shadow-2xl flex flex-col h-[85vh] overflow-hidden">
            ...
            <div className="flex items-center justify-between px-6 py-4 bg-gray-50 border-b">
              ...
              <button onClick={() => setIsOpen(false)} className="p-2 rounded-full hover:bg-gray-200 text-gray-600 transition-colors">
