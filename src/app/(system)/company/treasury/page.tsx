    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between border-b border-border pb-6">
        ...
        <div className="flex items-center gap-3">
          <Link href="/company/treasury/all" className="inline-flex flex-row-reverse items-center gap-2 rounded-xl bg-slate-100/80 hover:bg-slate-200 text-slate-700 px-4 py-2 text-sm font-bold transition-colors">
