...
export default function NewWorkItemDialog({ projectId, onSuccess }: NewWorkItemDialogProps) {
          ...
          <div className="relative w-full max-w-2xl max-h-[90vh] flex flex-col rounded-2xl bg-background shadow-2xl overflow-hidden border border-border">
            ...
            <div className="flex items-center justify-between border-b border-navy/10 bg-navy px-6 py-4 shrink-0 shadow-sm relative z-10">
              <div className="text-right w-full">
                <h2 className="text-xl font-bold text-white">إضافة بند أعمال جديد</h2>
                <p className="mt-1 text-sm text-white/80">هذا البند سيكون متاحاً للاستخدام في عقود مقاولي الباطن ومستخلصات هذا المشروع فقط.</p>
              </div>
