...
export default async function ProjectTransfersPage({
  ...
  // Sub-filter locally as it's safer for foreign table checks in early setup
  ...
  return (
    <div>
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-text-primary">أذون التحويل للمشروع</h1>
