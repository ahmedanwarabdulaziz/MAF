...
export default function NewProjectModal({ isOpen, onClose }: Props) {
  ...
  const initialForm = {
    arabic_name: '',
    english_name: '',
    project_onboarding_type: 'new', // Defaulting to 'new' since we removed the selection
    status: 'active',
    owner_party_id: '',
    location: '',
    start_date: '',
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" dir="rtl">
      ...
      <div className="relative z-10 w-full max-w-2xl max-h-[90vh] flex flex-col rounded-2xl bg-background shadow-2xl overflow-hidden border border-border">
        ...
        <div className="flex items-center justify-between border-b border-white/10 bg-navy px-6 py-4 shrink-0">
          <div>
            <h2 className="text-xl font-bold text-white">مشروع جديد</h2>
            <p className="mt-1 text-sm text-white/80">أدخل بيانات المشروع الأساسية</p>
          </div>
